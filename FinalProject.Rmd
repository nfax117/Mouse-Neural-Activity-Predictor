...
colnames(completeDF)[1] <- "cluster_number"
colnames(clusterDF)[1] <- "cluster_number"

# One point is one row in dataframe
# Append this vector to dataframe to see which rows relate to which cluster
# Make separate dataframes of each cluster
# run graphs and plots on these
