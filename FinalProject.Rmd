...
# Plots for variables against trials (for individual session analyis)

for (i in 1:18) {
 
  plot1 <- ggplot(sessionDF[sessionDF$session_number == i,], aes(x = trial_number, y = number_of_active_neurons)) + geom_point() + geom_smooth(formula = y ~ x, method="lm") + ggtitle("Scatterplot of Number of Active Neurons Against Trials") + labs(y = "Number of Active Neurons", x = "Trials")
  
  plot2 <- ggplot(sessionDF[sessionDF$session_number == i,], aes(x = trial_number, y = total_number_of_spks)) + geom_point() + geom_smooth(formula = y ~ x, method="lm") + ggtitle("Scatterplot of Total Number of Spikes Against Trials") + labs(y = "Total Number of Spikes", x = "Trials")
  
  plot3 <- ggplot(sessionDF[sessionDF$session_number == i,], aes(x = trial_number, y = proportion_of_active_neurons)) + geom_point() + geom_smooth(formula = y ~ x, method="lm") + ggtitle("Scatterplot of Proportion of Active Neurons Against Trials") + labs(y = "Proportion of Active Neurons", x = "Trials")
  
  plot4 <- ggplot(sessionDF[sessionDF$session_number == i,], aes(x = trial_number, y = firing_rate)) + geom_point() + geom_smooth(formula = y ~ x, method="lm") + ggtitle("Scatterplot of Firing Rate Against Trials") + labs(y = "Firing Rate", x = "Trials")
