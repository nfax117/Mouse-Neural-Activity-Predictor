...
# Ask if we should use more than 3. How do we know how many clusters we should have since we cant plot.
...
cluster1.logReg <- glm(feedback_type ~ scale(contrast_left)*cluster1.pc$PC1 , data = cluster1DF, family = "binomial")
